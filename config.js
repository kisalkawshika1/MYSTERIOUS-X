...
DATABASE_URL = process.env.DATABASE_URL === undefined ? './MYSTERIOUS-X.db' : process.env.DATABASE_URL;
...
module.exports = {
    ...
    CCN: "Ikyy69",
    DATABASE: DATABASE_URL === './MYSTERIOUS-X.db' ? new Sequelize({ dialect: "sqlite", storage: DATABASE_URL, logging: DEBUG }) : new Sequelize(DATABASE_URL, { dialectOptions: { ssl: { require: true, rejectUnauthorized: false } }, logging: DEBUG }),
